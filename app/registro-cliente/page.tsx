...
import { ArrowLeft, User, Mail, Phone, MapPin, MessageSquare } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Label } from "@/components/ui/label"
import { Textarea } from "@/components/ui/textarea"
import { useToast } from "@/hooks/use-toast"
import { clientesApi } from "@/src/app/expositores/api/clientes"
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl p-8 border-2 border-green-100">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-green-800 mb-2">Registro de Cliente</h1>
              <p className="text-gray-600">Cadastre os visitantes interessados em seus produtos</p>
            </div>
