...
import { segmentosApi } from "@/src/app/expositores/api/segmentos"
import { expositoresApi } from "@/src/app/expositores/api/expositores"
...
export default function ExhibitorRegistration() {
  ...
  const [exhibitorType, setExhibitorType] = useState<"juridica" | "fisica">("juridica")
  ...
  const loadSegmentos = async () => {
    try {
      ...
      toast({
        ...
        description: "Não foi possível carregar os segmentos. Verifique a conexão com a API.",
        variant: "destructive",
      })
      setSegmentos([])
    }
    ...
    try {
      const payload = {
        e_expositor: {
          ...
          nome_completo: exhibitorType === "fisica" ? formData.displayName : null,
          cpf: exhibitorType === "fisica" ? formData.document : null,
          responsavel: exhibitorType === "juridica" ? formData.responsibleName : formData.displayName,
      ...
      toast({
        ...
        description: "Seu cadastro foi realizado com sucesso na AGROTEC PVH 2025.",
      })
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl p-8 border-2 border-green-100">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-green-800 mb-2">Cadastro de Expositor</h1>
              <p className="text-gray-600">Participe da feira como empresa ou produtor autônomo</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-3">
                <Label className="text-green-800 font-semibold">Tipo de Expositor *</Label>
                <RadioGroup value={exhibitorType} onValueChange={handleTypeChange} className="flex gap-4">
              ...
              {exhibitorType === "juridica" ? (
                <>
                  <div className="space-y-2">
                    <Label htmlFor="companyName" className="text-green-800 font-semibold">
                      Nome da Empresa *
                    </Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="responsibleName" className="text-green-800 font-semibold">
                      Nome do Responsável *
                    </Label>
                    <div className="relative">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.segment} onValueChange={(value) => handleChange("segment", value)} required>
              ...
              <Button type="submit" className="w-full amazon-gradient hover:opacity-90 text-lg py-6" disabled={loading}>
