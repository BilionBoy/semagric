...
export const tiposExpositoresApi = {
  ...
  create: (data: Partial<TipoExpositor>) => api.post<TipoExpositor>("/e_tipo_expositores", data),

  update: (id: number, data: Partial<TipoExpositor>) => api.put<TipoExpositor>(`/e_tipo_expositores/${id}`, data),
